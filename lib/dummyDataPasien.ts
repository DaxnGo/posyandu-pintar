...
export const PERIOD_IDX: Record<number, number> = { 0:0, 6:1, 12:2, 18:3, 24:4, 30:5, 36:6 };
...
const bNN:  Pasien["statusByPeriod"] = [N,N,N,N,N,N,N];
const bT6:  Pasien["statusByPeriod"] = [T,N,N,N,N,N,N];
const bT12: Pasien["statusByPeriod"] = [T,T,N,N,N,N,N];
const bT18: Pasien["statusByPeriod"] = [T,T,T,N,N,N,N];
const bT24: Pasien["statusByPeriod"] = [T,T,T,T,N,N,N];
const bS12: Pasien["statusByPeriod"] = [S,T,N,N,N,N,N];
const bS18: Pasien["statusByPeriod"] = [S,S,T,N,N,N,N];
const bS24: Pasien["statusByPeriod"] = [S,S,S,T,N,N,N];
const bS30: Pasien["statusByPeriod"] = [S,S,S,S,T,N,N];
const bS36: Pasien["statusByPeriod"] = [S,S,S,S,S,T,N];

// Ibu: malgizi recovery timelines (matches dummyDataIbu progression)
const iNN:  Pasien["statusIbuByPeriod"] = [n,n,n,n,n,n,n];
const iM6:  Pasien["statusIbuByPeriod"] = [m,n,n,n,n,n,n];
const iM12: Pasien["statusIbuByPeriod"] = [m,m,n,n,n,n,n];
const iM18: Pasien["statusIbuByPeriod"] = [m,m,m,n,n,n,n];
const iM24: Pasien["statusIbuByPeriod"] = [m,m,m,m,n,n,n];
const iM30: Pasien["statusIbuByPeriod"] = [m,m,m,m,m,n,n];
const iM36: Pasien["statusIbuByPeriod"] = [m,m,m,m,m,m,n];
...
const dummyDataPasien: Pasien[] = [
  ...
  mk("PS-1029","Budi Santoso",   "Siti Rahma",   24,10.5,82,-2.1,44.0,"12 Okt 2023", [S,S,T,T,N,N,N], iM18),
  mk("PS-1030","Aisyah Putri",   "Dewi Lestari", 18,11.2,80, 0.5,58.0,"12 Okt 2023", bNN, iNN),
  mk("PS-1031","Rizky Aditya",   "Nurmala",      36,13.0,90,-1.8,47.5,"11 Okt 2023", bT18, iM12),
  mk("PS-1032","Sari Kusuma",    "Rina Susanti",  12, 9.0,74, 0.1,55.0,"11 Okt 2023", bNN, iNN),
  mk("PS-1033","Dwi Saputra",    "Lia Kusuma",   48,14.5,98,-2.3,43.5,"10 Okt 2023", [S,S,S,T,T,N,N], iM18),
  ...
  mk("PS-1036","Nadia Husna",    "Fatimah",      30,12.5,88,-1.9,46.0,"09 Okt 2023", bT24, iM12),
  ...
  mk("PS-1039","Hendra Kurnia",  "Sumiati",      42,13.8,95,-2.5,45.0,"07 Okt 2023", [S,S,T,T,N,N,N], iM12),
  mk("PS-1040","Putri Ayu",      "Rini Hartati",  9, 8.1,70, 0.6,60.0,"07 Okt 2023", bNN, iNN),
  mk("PS-1041","Bagas Prayoga",  "Endah Sari",   28,11.5,86,-1.5,48.5,"06 Okt 2023", bT6, iM6),
  ...
  mk("PS-1047","Agus Setiawan",  "Dewi Murni",   27,11.3,85,-1.6,46.5,"03 Okt 2023", bT12, iM6),
  ...
  mk("PS-1127","Reza Hadianto",  "Suryani",       18,10.3,78,-1.2,55.0,"24 Agu 2023", bT6, iNN),
  mk("PS-1128","Rizal Saputra",  "Rumini",        24,11.0,83,-1.4,57.5,"24 Agu 2023", bT6, iNN),
  mk("PS-1129","Ryan Santoso",   "Tarsih",        12, 9.0,73,-1.1,56.0,"23 Agu 2023", bT6, iNN),
  mk("PS-1130","Sabil Fikri",    "Ponijah",       30,12.3,88,-1.3,58.0,"23 Agu 2023", bT6, iNN),
  mk("PS-1131","Sakti Nugroho",  "Lasmi",         20,10.6,80,-1.5,55.5,"22 Agu 2023", bT6, iNN),
  mk("PS-1132","Shafira Rahma",  "Srimulyati",    16,10.0,77,-1.2,57.0,"22 Agu 2023", bT6, iNN),
  mk("PS-1133","Sofi Azzahra",   "Pariyem",       26,11.6,86,-1.4,56.5,"21 Agu 2023", bT6, iNN),
  mk("PS-1134","Surya Andika",   "Wartini",       14, 9.7,76,-1.3,58.5,"21 Agu 2023", bT6, iNN),
  mk("PS-1135","Syahril Arif",   "Rukmini",       22,11.1,82,-1.1,55.0,"20 Agu 2023", bT6, iNN),
  mk("PS-1136","Tegar Wibowo",   "Suparni",       28,12.0,87,-1.5,57.5,"20 Agu 2023", bT6, iNN),
  mk("PS-1137","Tifani Putri",   "Katini",        10, 8.6,71,-1.2,59.0,"19 Agu 2023", bT6, iNN),
  mk("PS-1138","Tito Prasetya",  "Suminih",       32,12.8,90,-1.4,56.0,"19 Agu 2023", bT6, iNN),
  mk("PS-1139","Ulfa Salsabila", "Ngatini",        8, 7.8,68,-1.3,58.0,"18 Agu 2023", bT6, iNN),
  mk("PS-1140","Vino Saputra",   "Saritem",       19,10.5,80,-1.1,57.0,"18 Agu 2023", bT6, iNN),
  // Recover at period 12 (7 patients)
  mk("PS-1141","Wahyu Pramono",  "Suginem",       25,11.5,85,-1.6,55.5,"17 Agu 2023", bT12, iNN),
  mk("PS-1142","Wendi Kusuma",   "Sarminah",      15,10.0,77,-1.8,57.0,"17 Agu 2023", bT12, iNN),
  mk("PS-1143","Wisnu Santoso",  "Tumisih",       21,10.8,82,-1.5,56.0,"16 Agu 2023", bT12, iNN),
  mk("PS-1144","Yoga Pratama",   "Wainem",        33,13.0,91,-1.7,58.5,"16 Agu 2023", bT12, iNN),
  mk("PS-1145","Yogi Firmansyah","Sarinem",       17,10.2,78,-1.6,55.0,"15 Agu 2023", bT12, iNN),
  mk("PS-1146","Yudha Putra",    "Karyati",       28,12.1,87,-1.8,57.5,"15 Agu 2023", bT12, iNN),
  mk("PS-1147","Zulfa Amani",    "Sukirah",       12, 9.1,73,-1.5,56.5,"14 Agu 2023", bT12, iNN),
  // Recover at period 18 (10 patients)
  mk("PS-1148","Akbar Maulana",  "Parini",        20,10.7,80,-1.9,55.0,"14 Agu 2023", bT18, iNN),
  mk("PS-1149","Andika Wirawan", "Sukemi",        27,11.9,87,-1.7,57.0,"13 Agu 2023", bT18, iNN),
  mk("PS-1150","Arya Bimantara", "Sukarti",       14, 9.7,76,-1.8,56.5,"13 Agu 2023", bT18, iNN),
  mk("PS-1151","Aziz Hamdani",   "Tuminah",       23,11.2,84,-1.6,58.0,"12 Agu 2023", bT18, iNN),
  mk("PS-1152","Dafa Ramadhan",  "Warsini",        9, 8.4,70,-1.9,55.5,"12 Agu 2023", bT18, iNN),
  mk("PS-1153","Deva Arjuna",    "Suratmi",       31,12.6,90,-1.7,57.5,"11 Agu 2023", bT18, iNN),
  mk("PS-1154","Diko Prasetyo",  "Sarinem",       18,10.4,79,-1.8,56.0,"11 Agu 2023", bT18, iNN),
  mk("PS-1155","Edwin Saputra",  "Ngatinem",      25,11.5,85,-1.6,58.5,"10 Agu 2023", bT18, iNN),
  mk("PS-1156","Feri Ardana",    "Pariyem",       13, 9.4,75,-1.9,55.0,"10 Agu 2023", bT18, iNN),
  mk("PS-1157","Gunawan Aji",    "Wartinah",      29,12.2,88,-1.7,57.0,"09 Agu 2023", bT18, iNN),
  // Recover at period 24 (5 patients)
  mk("PS-1158","Hasan Wibowo",   "Rubiyem",       22,11.0,82,-1.9,56.5,"09 Agu 2023", bT24, iNN),
  mk("PS-1159","Ivan Kurniawan", "Sukirem",       16,10.1,78,-1.8,58.0,"08 Agu 2023", bT24, iNN),
  mk("PS-1160","Jefri Santoso",  "Ngatinah",      33,13.1,91,-1.7,55.5,"08 Agu 2023", bT24, iNN),
  mk("PS-1161","Kevin Aditya",   "Sarijem",       11, 8.7,72,-1.9,57.5,"07 Agu 2023", bT24, iNN),
  mk("PS-1162","Luki Prasetyo",  "Wainem",        26,11.6,86,-1.8,56.0,"07 Agu 2023", bT24, iNN),
